---
title: "Analysis of Factors Affecting Credit Rating" 
...
#####Still playing around with graphs to see what works
```{r}
# Scatter plot 
ggplot(my_data, aes(x = credit_utilization_ratio, y = number_of_late_payments)) +
  geom_point() +
  geom_smooth(method = "lm", col = "red") +
  labs(title = 'title will be here', x = 'x axis label will be here', y = 'y axis label will be here')
...
ggplot(my_data, aes(x = occupation)) +
  geom_bar(fill = 'blue') +
  labs(title = 'Distribution of individuals by occupation in sample', x = 'Occupation type', y = 'Count')
