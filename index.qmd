...
Correlation coefficient `r cor(my_data$debt_to_income_ratio, my_data$credit_utilization_ratio)`
...
t_test <- t.test(my_data$credit_utilization_ratio, my_data$number_of_late_payments, data = my_data)
t_test
```
